...
The page is designed for mobile, desktop, and in between. 
<br/>
This is a mock website for a vape shop, which holds different section, 
clickable and viewable images, and a functioning contact form which saves info to google firebase
and sends emails to the store and client via axios post calls, which then use nodemailer to send
gmail message.
